...
/**
 * FoodWebApiCall helps call APIs in this module
 * Each API is called through this class
 */
public abstract class FoodWebApiCall extends AsyncTask<Void, Integer, String> {

    //Abstract method declaration for communicating with it's chlid class FoodCallWS
     ...
     * */
    public FoodWebApiCall(Activity mActivity, String mURL, boolean isProgressVisible) {
        ...
        if (isProgressVisible) {
            ...
            progressDialog.setMessage(mActivity.getResources().getString(R.string.food_please_wait));
     ...
     * */
    public FoodWebApiCall(Activity mActivity, String mURL, boolean isProgressVisible, String requestMethod, String parameters) {
        this.mActivity = mActivity;
        this.mURL = mURL;
        this.isProgressVisible = isProgressVisible;
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            if (requestMethod.equals(WebUtil.RequestMethod.POST)) {
    ...
    protected void onPostExecute(String response) {
        ...
        //Passing received result to FoodCallWS class by abstract methods
