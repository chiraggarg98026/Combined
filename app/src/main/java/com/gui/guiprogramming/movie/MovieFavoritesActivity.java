...
import com.gui.guiprogramming.movie.movie_adapter.MovieFavoritesAdapter;
import com.gui.guiprogramming.movie.movie_helper.MovieAppHelper;
import com.gui.guiprogramming.movie.movie_model.Movie;

import java.util.List;

public class MovieFavoritesActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.movie_activity_favorites);
        ...
        lvFavMovies.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                startActivityForResult(
                        new Intent(MovieFavoritesActivity.this, MovieDetailActivity.class)
    ...
    private void getMoviesFromDB() {
        MovieDBManager movieDbManager = new MovieDBManager(MovieFavoritesActivity.this);
        ...
        listAdapter = new MovieFavoritesAdapter(mRowData, MovieFavoritesActivity.this);
